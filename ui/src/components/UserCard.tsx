import { faBuilding, faEnvelope, faGlobe, faMapMarkerAlt, faPhone, faSignsPost, faUserCircle } from "@fortawesome/free-solid-svg-icons";
  ...
  return (
    <CardContainer onClick={() => onCardClick(user)}>
      ...
      <CardUserData>
        ...
        <div>
          <i><FontAwesomeIcon icon={faSignsPost} /></i>
